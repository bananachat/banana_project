package banana_project.image;

import javax.swing.*;
import java.awt.*;

public class SetJOption {
    // 폰트 설정
    public static final Font p12 = new Font("맑은 코딕", Font.PLAIN, 12);    // 보통 12폰트
    public static final Font b12 = new Font("맑은 코딕", Font.BOLD, 12);    // 볼드 12폰트
    public static final Font b14 = new Font("맑은 코딕", Font.BOLD, 14);    // 볼드 14폰트
    // JOp 설정
