package banana_project.login;
  ...
  public class PwFind extends JFrame implements ActionListener, MouseListener {
    // 클라이언트 연결
    Client client = null;
    // 화면부 선언
    ...
    JTextField jtf_userId = new JTextField("  아이디") {
      @Override
      public void setBorder(Border border) {
      }
    };
    ...
    JButton jbtn_reset = new JButton("비밀번호 찾기");
    JButton jbtn_main = new JButton(img_pwFind); // 메인 로고 이미지 붙이기
